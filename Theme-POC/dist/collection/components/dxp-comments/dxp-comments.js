...
export class Comments {
    ...
    /** Render the comments */
    render() {
        dxp.log.debug(this.element.tagName, 'render()', `in dxp-comments render() : ${process.env.MODE}`);
        const styles = [
        ...
        return (h("div", { class: this.base.componentClass(), dir: this.dir, "data-theme": this.theme },
            styles,
            h("div", { class: "comment-count" }, (this.domComments.length) ?
                h("h3", null,
                    this.commentCount,
                    " ",
                    (this.commentCount > 1) ? dxp.i18n.t('Comments:multipleCommentsText') : dxp.i18n.t('Comments:singleCommentText'))
                :
                    ''),
            h("dxp-textarea", { label: dxp.i18n.t('Comments:textarealabel'), ref: el => this.textAreaInput = el, placeholder: this.textareaPlaceholder ? this.textareaPlaceholder : dxp.i18n.t('Comments:commentplaceholder'), "max-length": this.maxCharacters, required: false }),
            h("div", { class: "comment-hint" }, dxp.i18n.t('Comments:commentHint', { maxlength: this.maxCharacters })),
            h("div", { class: "editable-block" },
                h("dxp-cta-list", { "title-text": "", orientation: "horizontal" },
                    h("dxp-cta", { type: "button", "btn-id": "submitButton", "button-type": "primary", text: this.submitText ? this.submitText : dxp.i18n.t('Comments:submit'), onClick: e => this.submitHandler(e) }),
                    h("dxp-cta", { type: "button", "btn-id": "cancelButton", "button-type": "secondary", text: this.cancelText ? this.cancelText : dxp.i18n.t('Comments:cancel'), onClick: e => this.submitHandler(e) }))),
            h("div", { class: "comment-list" },
                this.domComments.length ? this.renderList(this.domComments) : '',
                (this.lastIndex < this.commentCount) &&
    ...
    static get is() { return "dxp-comments"; }
    ...
    static get properties() { return {
        ...
        "appId": {
            ...
            "docs": {
                "tags": [],
                "text": "prop holds application Id"
            },
            "attribute": "app-id",
            "reflect": false
        },
        "cancelText": {
            ...
            "docs": {
                "tags": [],
                "text": "prop Holds comments cancel button text"
            },
        ...
        "commentContentId": {
            ...
            "docs": {
                "tags": [],
                "text": "Holds comments content id"
            },
            "attribute": "comment-content-id",
            "reflect": false
        },
        "commentsLimit": {
            "type": "number",
            ...
            "docs": {
                "tags": [],
                "text": "Limit to show comments"
            },
            "attribute": "comments-limit",
            "reflect": false
        },
        "commentText": {
            "type": "any",
            ...
            "docs": {
                "tags": [],
                "text": "comment value in the text area"
            },
        ...
        "mockcommentUrl": {
            ...
            "docs": {
                "tags": [],
                "text": "mock comment json url"
            },
            "attribute": "mockcomment-url",
            "reflect": false
        },
        "needsModeration": {
            "type": "boolean",
            ...
            "docs": {
                "tags": [],
                "text": "prop holds needs of moderation value"
            },
            "attribute": "needs-moderation",
            "reflect": false
        },
        "repliesLimit": {
            "type": "number",
        ...
        "submitText": {
            ...
            "docs": {
                "tags": [],
                "text": "prop holds comments submit button text"
            },
        ...
        "textareaPlaceholder": {
            ...
            "docs": {
                "tags": [],
                "text": "prop holds comment textarea placeholder text"
            },
    ...
    static get listeners() { return [{
            ...
            "method": "clickActionMenuHandler",
            "target": undefined,
            "capture": false,
            "passive": false
        }, {
            "name": "clickEditComment",
            "method": "clickEditCommentHandler",
            "target": undefined,
            "capture": false,
            "passive": false
        }, {
            ...
            "method": "clickReplyCommentHandler",
            "target": undefined,
            "capture": false,
            "passive": false
        }, {
