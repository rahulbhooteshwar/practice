...
const BannerCarousel = class {
    ...
    render() {
        ...
        return (h("div", { class: this.base.componentClass(), dir: this.dir, "data-theme": this.theme }, styles, h("div", { class: "carousel-container", tabindex: "0", onFocus: () => this.onMouseover() }, this.slides ? this.slides.map(items => h("dxp-banner", { "banner-type": items['bannerType'], "banner-size": items['bannerSize'], "data-theme": items['dataTheme'], "eyebrow-title": items['eyebrowTitle'], "title-text": items['titleText'], "title-heading": items['titleHeading'], "sub-title": items['subTitle'], "enable-overlay": items['enableOverlay'], "overlay-position": items['overlayPosition'], "image-enable-overlay": items['imageEnableOverlay'], src: items['src'], "src-lg": items['srcLg'], "src-md": items['srcMd'], "image-title": items['imageTitle'], alt: items['alt'], href: items['href'], "open-in-new-tab": items['openInNewTab'], "focal-point": items['focalPoint'], "focal-point-lg": items['focalPointLg'], "focal-point-md": items['focalPointMd'], "position-of-image": items['positionOfImage'], responsive: items['responsive'], cta: items['cta'] })) :
            h("slot", null), this.showArrows ?
            h("div", { class: `nav-controls ${this.carouselState.navigationReady ? '' : 'dxp-none'}` }, h("span", { class: "prev", onFocus: () => this.focusNextPrev('PREV'), onBlur: () => this.blurNextPrev('PREV'), onClick: () => this.changeSlide('PREV'), "aria-controls": "carousel", "aria-label": dxp.i18n.t('BannerCarousel:prev') }), h("span", { class: "next", onFocus: () => this.focusNextPrev('NEXT'), onBlur: () => this.blurNextPrev('NEXT'), onClick: () => this.changeSlide('NEXT'), "aria-controls": "carousel", "aria-label": dxp.i18n.t('BannerCarousel:next') }))
            :
