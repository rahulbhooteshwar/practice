...
const BannerImageOverlay = class {
    ...
    renderBanerImageOverlay() {
        return (h("div", { class: this.overlayClass }, h("div", { class: this.animation && 'overlay-content-animation' }, (this.bannerType === BANNER_VIDEO) &&
            h("a", { "aria-label": dxp.i18n.t('BannerImageOverlay:videoPlayBtnText'), onClick: ev => this.toggleVideo(true, ev), href: "" }, h("img", { class: "play-icon", alt: dxp.i18n.t('BannerImageOverlay:videoPlayBtnAltText'), src: (this.srcVideoPlayImage && this.srcVideoPlayImage.length !== 0) ?
    ...
    render() {
        ...
        if (this.bannerType === 'image-overlay' || this.bannerType === BANNER_VIDEO) {
            return (h("div", { dir: this.dir, class: this.base.componentClass(), "data-theme": this.theme }, styles, this.isVideoShow &&
                h("div", { class: "overlay-video-block" }, h("span", { role: "button", class: "btn-close", id: "closeBtn", onClick: ev => this.toggleVideo(false, ev) }, h("span", { class: "dxp-icon dxp-icon-close white-cross-icon" })), h("div", { class: "align-middle" }, h("dxp-video", { type: this.videoType, "src-video": this.srcVideo, "icon-type": this.iconType, "disable-controls": this.disableControls, autoplay: this.autoPlay, "src-poster": this.srcPoster, "custom-mute-button": this.customMuteButton, "custom-mute-button-position": this.customMuteButtonPosition, "video-name": this.videoName, "video-description": this.videoDescription, "video-upload-date": this.videoUploadDate, muted: this.muted }))), h("div", { dir: this.dir, id: "sub-feature-image", class: this.cssClass }, this.addCircle ? h("span", { class: "before-span" }) : '', this.categoryTag ? h("p", { class: "category-tags" }, this.categoryTag) : '', (this.backgroundType !== SOLID_BACKGROUND_TYPE) &&
...
const Search = class {
    ...
    renderAdvanceSearch() {
        ...
        return (h("div", { role: "application", class: `${this.base.componentClass()} search-wrapper`, dir: this.dir, "data-theme": this.theme }, styles, h("section", { role: "search" }, h("div", null, h("span", { class: "dxp-icon dxp-icon-medium dxp-icon-search search-icon", tabindex: "0", "aria-label": dxp.i18n.t(SEARCH_ACCESSIBILITY_TEXT), onClick: this.searchBoxToggle.bind(this) }), h("div", { class: `${this.base.componentClass()} search-container${this.showSearchBox ? ' expand-container' : ' collapse-container'}` }, h("div", { class: "overlay dxp-none" }), h("div", { class: "dxp-row dxp-row-rotate", tabindex: "-1" }, h("div", { class: "dxp-col-md-4 dxp-col-12 cta-container-mobile" }, h("slot", { name: "cta" })), h("div", { class: "dxp-col-md-8 dxp-col-12 search-box-container" }, h("div", { class: "wrapper search-box-outer-container" }, h("input", { type: "search", "aria-label": dxp.i18n.t('Search:customMessage'), role: "combobox", "aria-haspopup": "listbox", name: "searchbox", class: `dxp-form-control searchbox searchbox-${this.searchBoxSize} ${(this.showSearchBoxList && this.searchValue.length >= 3) ? NO_BORDER_RADIUS : ''}`, placeholder: this.placeholder, onInput: event => { this.onTextInput(event); } }), h("span", { class: "dxp-icon dxp-icon-large dxp-icon-search search-text", tabindex: "0", "aria-label": dxp.i18n.t(SEARCH_ACCESSIBILITY_TEXT), onClick: this.searchData.bind(this) }), h("span", { class: `dxp-icon dxp-icon-small dxp-icon-close dxp-icon-clear dxp-icon-clear-${this.searchBoxSize} ${this.searchValue.length ? BLOCK : ' dxp-none'}`, "aria-label": dxp.i18n.t(SEARCH_CLEAR), tabindex: "0", onClick: () => this.clearSearchBox() })), h("div", { class: `dxp-list-container ${(this.showSearchBoxList && this.searchValue.length >= 3) ? 'dxp-block' : ''}` }, h("ul", { class: "dxp-suggestion-list", "aria-label": dxp.i18n.t(SEARCH_LIST_TEXT) }, this.searchDataCombined && this.searchDataCombined.map(suggestTerm => h("li", { tabindex: "-1", class: "dxp-dropdown-list-item", "aria-label": dxp.i18n.t(SEARCH_SELECTED_ITEM, { item: suggestTerm }), onClick: this.selectSuggestion.bind(this) }, suggestTerm)), h("span", { tabindex: "0", class: "cta-container", onClick: () => this.onViewAllSelection() }, h("dxp-cta", { type: "link", text: dxp.i18n.t('Search:ctaText') })))))), h("span", { class: "dxp-icon dxp-icon-large dxp-icon-close search-wrapper-close-icon", title: dxp.i18n.t('Search:closeText'), "aria-label": dxp.i18n.t('Search:close'), role: "button", tabindex: "0", onClick: this.closeSearchBox.bind(this) }))))));
    }
    ...
    renderHomePageSearch() {
        ...
        return (h("div", { role: "application", class: `${this.base.componentClass()} search-wrapper homepage-search`, dir: this.dir, "data-theme": this.theme }, styles, h("div", { class: "dxp-col-12 search-box-container dxp-p-0" }, h("div", { class: "wrapper-home-search" }, h("div", { class: "autowriter-wrapper", onClick: () => this.disableAutowriter() }, h("slot", { name: "autowriter" })), h("input", { type: "search", "aria-haspopup": "listbox", name: "homepageSearch", "aria-label": this.placeholder, class: `dxp-form-control search search-bar ${(this.showSearchBoxList && this.searchValue.length >= 3) ? NO_BORDER_RADIUS : ''}`, onFocus: () => this.disableAutowriter(), onInput: event => { this.onTextInput(event); } }), h("span", { class: "dxp-icon dxp-icon-medium dxp-icon-search search-text", tabIndex: 0, "aria-label": dxp.i18n.t(SEARCH_ACCESSIBILITY_TEXT), onClick: this.searchData.bind(this) }), h("span", { class: `dxp-icon dxp-icon-small dxp-icon-close dxp-icon-clear ${this.searchValue.length ? BLOCK : ' dxp-none'}`, "aria-label": dxp.i18n.t(SEARCH_CLEAR), tabIndex: 0, onClick: () => this.clearSearchBox() })), h("div", { class: `dxp-simple-list-container ${(this.showSearchBoxList && this.searchValue.length >= 3) ? 'dxp-block' : ''}` }, h("ul", { class: "dxp-suggestion-list", "aria-label": dxp.i18n.t(SEARCH_LIST_TEXT) }, this.searchDataCombined && this.searchDataCombined.map(suggestTerm => h("li", { tabIndex: -1, class: "dxp-dropdown-list-item", "aria-label": dxp.i18n.t(SEARCH_SELECTED_ITEM, { item: suggestTerm }), onClick: this.selectSuggestion.bind(this) }, suggestTerm)))))));
    }
    ...
    renderSimpleSearch() {
        ...
        return (h("div", { role: "application", class: `${this.base.componentClass()} search-wrapper simple-search`, dir: this.dir, "data-theme": this.theme }, styles, h("div", { class: "dxp-col-12 search-box-container dxp-p-0" }, h("div", { class: "wrapper" }, h("input", { type: "search", "aria-haspopup": "listbox", name: "searchbox", "aria-label": this.placeholder, class: `dxp-form-control searchbox searchbox-${this.searchBoxSize} ${(this.showSearchBoxList && this.searchValue.length >= 3) ? NO_BORDER_RADIUS : ''}`, placeholder: this.placeholder, onInput: event => { this.onTextInput(event); } }), h("span", { class: "dxp-icon dxp-icon-medium dxp-icon-search search-text", tabIndex: 0, "aria-label": dxp.i18n.t(SEARCH_ACCESSIBILITY_TEXT), onClick: this.searchData.bind(this) }), h("span", { class: `dxp-icon dxp-icon-small dxp-icon-close dxp-icon-clear dxp-icon-clear-${this.searchBoxSize} ${this.searchValue.length ? BLOCK : ' dxp-none'}`, "aria-label": dxp.i18n.t(SEARCH_CLEAR), tabIndex: 0, onClick: () => this.clearSearchBox() })), h("div", { class: `dxp-simple-list-container ${(this.showSearchBoxList && this.searchValue.length >= 3) ? 'dxp-block' : ''}` }, h("ul", { class: "dxp-suggestion-list", "aria-label": dxp.i18n.t(SEARCH_LIST_TEXT) }, this.searchDataCombined && this.searchDataCombined.map(suggestTerm => h("li", { tabIndex: -1, class: "dxp-dropdown-list-item", "aria-label": dxp.i18n.t(SEARCH_SELECTED_ITEM, { item: suggestTerm }), onClick: this.selectSuggestion.bind(this) }, suggestTerm)))))));
    }
