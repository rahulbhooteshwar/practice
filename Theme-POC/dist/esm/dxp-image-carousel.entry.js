...
const ImageCarousel = class {
    ...
    render() {
        ...
        return (h("div", { class: this.base.componentClass(), dir: this.dir, "data-theme": this.theme }, styles, h("div", { class: "carousel-container", tabindex: "0", ref: es => this.carouselContainer = es }, this.carouselData ? this.carouselData.map(item => h("dxp-image-slide", { "eyebrow-title": item['eyebrow-title'], "slide-caption": item['slide-caption'], "sub-title": item['sub-title'], src: item.src, alt: item.alt, "image-title": item['image-title'] })) :
            h("slot", null)), h("div", { class: "bar-container" }, h("div", { class: "carousel-progress-values dxp-eyebrow-lg" }, h("span", { class: "current-value", ref: es => this.activeSlide = es }, " /"), h("span", { class: "max-value", ref: es => this.totalSlides = es })), h("div", { class: "carousel-progress-bar" }, h("div", { class: "carousel-current-progress", ref: es => this.carouselProgressbar = es })), h("div", { class: "arrow-container" }, h("div", { class: "prev-arrow", role: "button", "aria-label": dxp.i18n.t('ImageCarousel:prev'), tabindex: "0", onClick: e => this.prevSlide(e), onKeyPress: e => this.prevSlide(e), ref: es => this.prev = es }), h("div", { class: "next-arrow", role: "button", "aria-label": dxp.i18n.t('ImageCarousel:next'), tabindex: "0", onClick: e => this.nextSlide(e), onKeyPress: e => this.nextSlide(e), ref: es => this.next = es })))));
    }
