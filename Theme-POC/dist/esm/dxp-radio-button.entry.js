...
const RadioButton = class {
    ...
    render() {
        ...
        return (h("div", { class: `${this.base.componentClass()} ${this.alignment}`, dir: this.dir, "data-theme": this.theme }, styles, h("input", { onChange: ev => this.handleChange(ev), id: this.radioKey, type: "radio", key: this.radioKey, name: this.name, value: this.radioValue, checked: this.checked, disabled: this.isDisabled }), h("label", { htmlFor: this.radioKey }, this.radioKey)));
    }
