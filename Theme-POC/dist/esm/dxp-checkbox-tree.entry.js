...
const CheckboxTree = class {
    ...
    render() {
        ...
        return (h("div", { class: this.base.componentClass(), dir: this.dir, "data-theme": this.theme }, styles, h("span", { class: "chkbox-tree-node-noresult dxp-none" }, dxp.i18n.t('CheckboxTree:noResult')), h("div", { ref: el => this.contentItemsContainer = el })));
    }
