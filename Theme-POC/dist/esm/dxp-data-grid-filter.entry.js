...
const DataGridFilter = class {
    ...
    render() {
        return (h("div", { class: this.base.componentClass(), "data-theme": this.theme }, h("div", { class: "options-wrapper" }, h("a", { href: "javascript : void(0)", onClick: e => this.sortDataGrid(e, 'ascending'), class: `sort-btn ${this.selectedSort === 'ascending' ? IS_SELECTED : ''}` }, h("i", { class: "btn-icon asc-icon" }), dxp.i18n.t('DataGrid:sortAscText')), h("a", { href: "javascript : void(0)", onClick: e => this.sortDataGrid(e, 'descending'), class: `sort-btn ${this.selectedSort === 'descending' ? IS_SELECTED : ''}` }, h("i", { class: "btn-icon desc-icon" }), dxp.i18n.t('DataGrid:sortDescText')), h("a", { href: "javascript : void(0)", onClick: e => this.sortDataGrid(e, 'remove-sort'), class: "sort-btn" }, h("i", { class: "btn-icon cross-icon" }), dxp.i18n.t('DataGrid:removeSortText'))), h("div", { class: "options-wrapper" }, h("dxp-toggle-switch", { label: "Pin this column", description: this.maxPinError, "label-position": "left", checked: this.isPinned, disabled: this.isPinDisabled })), h("div", { class: "options-wrapper", ref: el => { this.filterElement = el; } }, h("div", { class: "option-section" }, h("div", { class: "dropdown-label" }, dxp.i18n.t('DataGrid:filterConditionText')), h("select", { class: "dropdown", onChange: event => this.handleSelect(event) }, h("option", { value: "notSelected", selected: this.selectedValue === 'notSelected' }, dxp.i18n.t('DataGrid:selectText')), h("option", { value: "isEqualTo", selected: this.selectedValue === 'isEqualTo' }, dxp.i18n.t('DataGrid:isEqualToText')), h("option", { value: "isNotEqualTo", selected: this.selectedValue === 'isNotEqualTo' }, dxp.i18n.t('DataGrid:isNotEqualToText')))), h("div", { class: "option-section" }, h("dxp-input", { type: "text", label: dxp.i18n.t('DataGrid:valueText'), value: this.enteredValue, "is-required": "true", disabled: this.selectedValue === 'notSelected' || this.selectedValue === '' || this.selectedValue === undefined, "max-length": "100", "accessibility-text": "{dxp.i18n.t('DataGrid:filterAccesibilityText')}", placeholder: dxp.i18n.t('DataGrid:searchText') })), h("dxp-cta-list", { "title-text": "", orientation: "horizontal" }, h("dxp-cta", { type: "button", "btn-id": "filterButton", disabled: (this.selectedValue === 'notSelected' || this.selectedValue === ''
