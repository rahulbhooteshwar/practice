...
const ContentItem = class {
    ...
    getContentOfVideo() {
        return (h("div", { class: `content-video ${this.orientation}` }, h("img", { class: "content-background-img", src: this.srcPoster, alt: dxp.i18n.t('ContentItem:videoPosterImageText') }), h("a", { class: `play-icon ${this.playIconBottomLeft ? 'bottom-left' : 'center'}`, "aria-label": dxp.i18n.t('ContentItem:videoPlayBtnText'), onClick: ev => this.toggleVideo(true, ev), href: "" }, h("img", { alt: dxp.i18n.t('ContentItem:videoPlayBtnText'), src: `${"https://asset.mastercard.com/dxp-ui/assets"}/images/icons/play-icon-${this.iconType}.png` }))));
    }
    /** show video overlay block */
    getVideoOverlay() {
        return (h("div", { class: "overlay-video-block" }, h("a", { role: "button", class: "btn-close", "aria-label": dxp.i18n.t('ContentItem:close'), onClick: ev => this.toggleVideo(false, ev), href: "" }, h("span", { class: "dxp-icon dxp-icon-large dxp-icon-close white-cross-icon", title: dxp.i18n.t('ContentItem:closeText') })), h("div", { class: "align-middle" }, h("dxp-video", { type: this.type, "icon-type": this.iconType, "src-video": this.srcVideo, "src-poster": this.srcPoster, autoplay: this.autoplay, "disable-controls": this.disableControls, "custom-mute-button": this.customMuteButton, "custom-mute-button-position": this.customMuteButtonPosition, "video-name": this.videoName, "video-description": this.videoDescription, "video-upload-date": this.videoUploadDate }))));
    }
    ...
    renderHorizontalOrientation() {
        return ([this.headerType === 'image' ?
            ...
            h("div", { class: `content-text ${this.indentation ? 'indentation' : ''}` }, h("div", null, this.eyebrowText && h("p", { class: "dxp-title-eyebrow dxp-font-size-sm" }, this.eyebrowText), this.contentItemTitle && h("h3", { class: "dxp-title-3" }, h("a", { target: this.contentItemTitleTarget ? '_blank' : '_self', innerHTML: this.contentItemTitle }), this.badgeText && h("span", { class: "badge-cont" }, h("span", { ref: el => this.badgeRef = el, class: "badge-text" }, this.badgeText))), this.description && h("p", { class: this.descriptionTarget ? DESCRIPTION_HIDDEN_XS : 'description ', innerHTML: this.description }), h("div", { class: "cta-block", ref: el => this.ctaContainer = el }, h("slot", null))))]);
    }
    ...
    renderVerticalOrientaion() {
        return ([this.contentItemType === MEDIA_TOP ?
            ...
            [this.contentItemType !== MEDIA_TOP &&
                    h("div", { class: "cta-block", ref: el => this.ctaContainer = el }, h("slot", null))],
