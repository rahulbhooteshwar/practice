...
const NavMenu = class {
    ...
    render() {
        ...
        return (h("li", { class: `nav-item-li ${this.base.componentClass()}`, dir: this.dir, "data-theme": this.theme, role: "menu" }, styles, h("span", { class: "nav-item h5", tabindex: "0", onClick: () => { this.parentNavHandler(); }, role: "menuitem", "aria-haspopup": "true", "aria-label": this.accessibilityText ? this.accessibilityText : this.linkTitle }, this.navigationTitle), h("div", { class: "sub-nav-child-container", ref: el => this.subNavChildContainer = el }, h("div", { class: "quick-links-container dxp-col-lg-3", ref: el => this.quickLinksContainer = el }, h("slot", null), "\u00A0"), this.child &&
            h("div", { ref: el => this.groupContainer = el, class: "group-container dxp-col-lg-4 dxp-col-offset-lg-1" }, h("dxp-nav-item-container", null, h("div", { class: "dxp-scrollable-container" }, h("div", { class: "dxp-scrollable" }, h("ul", { ref: el => this.navGroupContainer = el }, h("slot", null)))))), !this.child &&
            h("div", { ref: el => this.groupContainer = el, class: "group-container dxp-col-lg-4 dxp-col-offset-lg-1" }, h("div", { class: "dxp-scrollable-container" }, h("div", { class: "dxp-scrollable" }, h("ul", null, h("slot", { name: "group-content" }))))))));
    }
