...
const DataGrid = class {
    ...
    render() {
        ...
        return (h("div", { class: `${this.base.componentClass()} data-grid`, dir: this.dir, "data-theme": this.theme, style: { 'width': this.width } }, h("div", { class: "dxp-flex grid-options" }, (this.enableExport) ?
            (h("div", { class: "dxp-flex align-center" }, h("div", { class: "action-menu dxp-flex" }, h("a", { href: "javascript : void(0)", role: "link", class: "action-export", onClick: e => this.toggleClick(e), onKeyPress: e => this.toggleKey(e), "aria-expanded": "false", "aria-label": dxp.i18n.t('DataGrid:export') }, h("span", null, dxp.i18n.t('DataGrid:export')), h("i", { class: "dxp-icon dxp-icon-caret-down" })), h("div", { class: "action-list-wrapper", ref: el => this.exportSection = el }, h("div", { class: "action-list" }, h("div", { class: "action-arrow" }), h("span", { class: "action-link" }, h("dxp-cta", { type: "link", "link-type": "dxp-btn-custom-link", href: "javascript : void(0)", "btn-id": "exportcsv", text: dxp.i18n.t('DataGrid:exportCSV'), onClick: e => this.submitHandler(e) })), h("span", { class: "action-link" }, h("dxp-cta", { type: "link", "link-type": "dxp-btn-custom-link", href: "javascript : void(0)", "btn-id": "exportpdf", text: dxp.i18n.t('DataGrid:exportPDF'), onClick: e => this.submitHandler(e) }))))), h("div", { class: "dxp-inline-block printer-icon" }, h("dxp-cta", { type: "link", "link-type": "dxp-btn-custom-link", href: "javascript : void(0)", "btn-id": "printpreview", "aria-label": dxp.i18n.t('DataGrid:printPreview'), "icon-align": "left", src: "https://fusion.mastercard.int/stash/projects/DXP/repos/dxp-demo-assets/raw/images/icons/printer.svg", text: dxp.i18n.t('DataGrid:printPreview'), onClick: e => this.submitHandler(e) })))) : '', (this.enableSearch) ?
            (h("div", { class: "search-block" }, h("div", { class: "search-wrapper" }, h("input", { type: "text", name: "searchbox", value: this.searchString, class: "dxp-form-control search-input", placeholder: dxp.i18n.t('DataGrid:searchText'), onKeyUp: event => { this.onSearchText(event); } }), h("span", { class: "dxp-icon dxp-icon-small dxp-icon-search search-icon" }), h("span", { tabindex: "0", role: "button", "aria-label": dxp.i18n.t('DataGrid:clearSearchText'), class: `dxp-icon dxp-icon-small dxp-icon-close ${(this.searchString.length ? ' dxp-flex' : ' dxp-none')}`, onClick: event => this.onSearchText(event), onKeyPress: event => this.onSearchText(event) })))) : ''), h("div", { class: "table-wrapper", style: { 'height': this.height }, onScroll: event => this.handlerDataGridScroll(event) }, h("div", { class: "data-grid dxp-data-grid-table" }, h("div", { class: `header-wrapper ${this.stickyHeader ? 'sticky-top' : ''}`, ref: el => (this.gridHeaders = el) }, h("slot", null)), h("div", { ref: el => (this.gridRows = el) }, h("slot", null))), (this.dataArray && !this.dataArray.length) ?
