...
const Input = class {
    ...
    render() {
        ...
        return (h("div", { class: this.base.componentClass(), "data-theme": this.theme }, styles, h("label", { class: (this.disabled ? 'dxp-disabled dxp-inputbox-label' : this.isValid ? 'dxp-inputbox-label' : 'dxp-inputbox-label dxp-error'), htmlFor: this.label }, this.label, this.isOptional ?
            ...
            : ''), h("div", { class: "input-container" }, h("input", { class: this.isValid ? '' : 'has-error', type: this.type, id: this.contentId, name: this.name, spellcheck: this.spellcheckRequired, "aria-invalid": !this.isValid, "aria-required": this.isOptional ? '' : 'true', "aria-label": this.accessibilityText, placeholder: this.placeholder, value: this.value, minlength: this.minLength, maxlength: this.maxLength, autocomplete: this.enableAutocomplete, onInput: event => this.handleChange(event), autoComplete: this.enableAutocomplete, readonly: this.readonly, disabled: this.disabled, autofocus: this.autoFocus, height: this.height, width: this.width, min: this.min, max: this.max, step: this.step, pattern: this.pattern }), !this.isValid && h("span", { class: "input-icon icon-sprite error-circle-red" }), this.isTypeCard ? h("span", { class: 'icon-inputs ' + this.cardType }) : '', this.isPassword ? h("span", { class: "icon-inputs view-pass-icon", onClick: e => this.togglePasswordIcon(e) }) : ''), this.isValid ? '' : h("div", { class: "dxp-error", id: "errMsg", "aria-label": this.validationMessage }, this.validationMessage)));
    }
