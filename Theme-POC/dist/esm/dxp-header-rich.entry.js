...
const HeaderRich = class {
    ...
    render() {
        ...
        ${this.isHeaderSticky ? ' dxp-header-sticky' : ''}`, dir: this.dir, "data-theme": this.theme }, styles, h("div", { class: `dxp-content-main ${this.backgroundType === 'transparent' ? 'transparent' : ''} header-container` }, h("div", { class: `dxp-row` }, h("div", { class: "dxp-col-12" }, h("div", { class: "header" }, this.isLogoPresent &&
            (h("div", { ref: el => this.headerContainer = el, class: "logo-container" }, h("slot", { name: "logo" }))), (this.isNavPresent || this.isNavSearch) &&
            ([
                h("div", { ref: el => this.headerContainer = el, class: "nav-search-container" }, h("div", { class: "nav-wrapper" }, h("slot", { name: "nav" })), h("div", { class: "search-wapper" }, h("slot", { name: "search" }))),
