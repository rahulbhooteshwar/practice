...
const Navigation = class {
    ...
    async componentWillLoad() {
        ...
        this.base.i18Init(core$1.dxp, 'Navigation', messages.messages);
    ...
    render() {
        core$1.dxp.log.debug(`in dxp-navigation render() : ${"DEVELOPMENT"}`);
        return (core$1.h("nav", { dir: this.dir, "data-theme": this.theme, class: `${this.base.componentClass()} nav-primary`, role: "navigation" }, core$1.h("ul", { class: "nav", role: "menu" }, this.navData && this.navData.navigationData
            ? this.navData.navigationData.map(navItem => core$1.h("dxp-nav-group", { "link-title": navItem['linkTitle'], "navigation-title": navItem['navigationTitle'], "menu-route-link": navItem['menuRouteLink'], "accessibility-text": navItem['accessibilityText'], child: navItem['child'] }))
            : core$1.h("slot", null))));
    }
...
exports.dxp_navigation = Navigation;
