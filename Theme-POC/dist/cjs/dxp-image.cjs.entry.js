...
const Image = class {
    ...
    calculateFocalPoint() {
        ...
        if (this.focalPoints !== undefined) {
            try {
                ...
                this.focalPoints = undefined;
                core$1.dxp.log.error(this.element.tagName, 'calculateFocalPoint()', 'Error message: ', err);
                return false;
            }
        }
    }
    ...
    emitAnalyticsData() {
        ...
        core$1.dxp.log.info(this.element.tagName, 'emitAnalytics()', analyticsInfoObj);
    }
    ...
    renderCaptions() {
        return ((this.captionTitle || this.captionEyebrow || this.captionSubtitle) && core$1.h("div", { class: this.captionPosition }, this.captionEyebrow && core$1.h("p", { class: "dxp-title-eyebrow dxp-font-size-lg" }, this.captionEyebrow), this.captionTitle && core$1.h("h3", { class: "dxp-title-1" }, this.captionTitle), core$1.h("p", { class: this.captionSubtitle ? 'description dxp-hidden-xs-only' : 'description' }, this.captionSubtitle)));
    }
    /** Render the image */
    render() {
        return (this.imgSrc && this.imgSrc.length ?
            core$1.h("div", { class: this.base.componentClass(), dir: this.dir }, core$1.h("link", { rel: "stylesheet", href: `` }), this.theme && [
                core$1.h("link", { rel: "stylesheet", href: `` }),
                core$1.h("link", { rel: "stylesheet", href: `${core$1.dxp.config.get('DXP_STYLE_BASE_URL')}/themes/${this.theme}/dxp-image.min.css` })
            ], this.dtmUrl && (core$1.h("script", { src: this.dtmUrl })), core$1.h("div", { class: "image-container" }, this.href ?
                core$1.h("a", { href: this.href, "aria-label": this.ariaLabel, target: this.openInNewTab ? '_blank' : '_self', onClick: () => this.emitAnalyticsData() }, core$1.h("img", { class: this.focalPoints && !this.responsive ? 'focal-point-img' : this.responsive ? 'dxp-img-fluid' : undefined, alt: this.alt, title: this.imageTitle, "data-src": this.imgSrc }), this.enableOverlay && core$1.h("div", { class: "overlay" }, core$1.h("p", null, this.imageTitle, core$1.h("slot", { name: "overlay" })))) :
                [
                    core$1.h("img", { class: this.focalPoints && !this.responsive ? 'focal-point-img' : this.responsive ? 'dxp-img-fluid' : undefined, alt: this.alt, title: this.imageTitle, "data-src": this.imgSrc }),
                    this.enableOverlay && core$1.h("div", { class: "overlay" }, core$1.h("p", null, this.imageTitle, core$1.h("slot", { name: "overlay" })))
