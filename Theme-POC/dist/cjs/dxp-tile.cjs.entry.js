...
const Tile = class {
    ...
    componentWillLoad() {
        ...
        this.base.i18Init(core$1.dxp, 'Tile', messages.messages);
    }
    /** key up events */
    handleUpkeyEvents(e) {
    ...
    getContentOfVideo() {
        return (core$1.h("div", { class: "content-video" }, core$1.h("img", { class: "content-background-img", src: this.srcPoster, alt: core$1.dxp.i18n.t('Tile:videoPosterImageText') }), core$1.h("a", { class: "play-icon", "aria-label": core$1.dxp.i18n.t('Tile:videoPlayBtnText'), onClick: event => this.toggleVideo(true, event) }, core$1.h("img", { alt: "image", src: `${"https://asset.mastercard.com/dxp-ui/assets"}/images/icons/play-icon-${this.iconType}.png` }))));
    }
    /** show video overlay block */
    getVideoOverlay() {
        const bodyEle = document.querySelector('body');
        bodyEle.style.overflow = 'hidden';
        return (core$1.h("div", { class: "overlay-video-block" }, core$1.h("a", { role: "button", class: "btn-close", "aria-label": core$1.dxp.i18n.t('TileVideo:close'), onClick: event => this.toggleVideo(false, event) }, core$1.h("span", { class: "dxp-icon dxp-icon-large dxp-icon-close white-cross-icon" })), core$1.h("div", { class: "align-middle" }, core$1.h("dxp-video", { type: this.videoType, "icon-type": this.iconType, "src-video": this.src, "src-poster": this.srcPoster, autoplay: this.autoPlay, "disable-controls": this.disableControls, "video-name": this.videoName, "video-description": this.videoDescription, "video-upload-date": this.videoUploadDate }))));
    }
