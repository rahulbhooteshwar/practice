...
const Calendar = class {
    constructor(hostRef) {
        ...
        this.message = '';
        this.calendarClick = core.createEvent(this, "calendarClick", 7);
    ...
    componentWillLoad() {
        ...
        this.base.i18Init(core.dxp, 'Calendar', messages);
        const shadow = this.element ? this.element : this.element;
        let href = ``;
        core.dxp.util.appendLinkElement(shadow, href);
        href = ``;
        core.dxp.util.appendLinkElement(shadow, href);
        href = `${core.dxp.config.get('DXP_STYLE_BASE_URL')}/themes/${this.theme}/dxp-calendar.min.css`;
        core.dxp.util.appendLinkElement(shadow, href);
    ...
    onClickHandler(event) {
        ...
        if (target.classList.contains(this.selectorDate)) {
            ...
            core.dxp.log.info(this.element.tagName, 'onClickHandler()', dateObj);
            this.isCalendarOpen = false;
        }
    ...
    getAriaLabelMonth(month) {
        return core.dxp.i18n.t('Calendar:accessibilitySelectedMonthText', { selectedMonth: this.months[month] });
    }
    /** get aria-label for year */
    getAriaLabelYear(year) {
        return core.dxp.i18n.t('Calendar:accessibilitySelectedYearText', { selectedYear: year });
    }
    ...
    setDateAttributes() {
        ...
        if (date) {
            const ariaLabel = `${core.dxp.i18n.t('Calendar:currentDate')} ${Number(date.innerHTML)} ${this.months[this.month]} ${this.year} ${core.dxp.i18n.t('Calendar:arrowKeysToMove')}`;
    ...
    setDefaultDate() {
        if (this.defaultDate) {
            ...
            if (dates && dates.length) {
                ...
                core.dxp.log.info(this.element.tagName, 'componentDidUpdate', 'Invalid default date format');
            }
        }
    }
    ...
    /** Render the calendar */
    render() {
        core.dxp.log.debug(this.element.tagName, 'render()', `in dxp-calendar render() : ${"DEVELOPMENT"}`);
        ...
        this.months = core.dxp.i18n.t('Calendar:monthList', { returnObjects: true });
        return (core.h("div", { class: this.base.componentClass(), dir: this.dir, "data-theme": this.theme }, core.h("div", { class: "calendar-picker" }, core.h("div", { class: "input-box-container" }, core.h("dxp-input", { "content-id": this.selectorInputSelectedDate, type: "text", label: `${this.label ? this.label : ''}`, value: `${this.selectedDate ? this.selectedDate : ''}`, "is-required": this.required, "max-length": "100", "accessibility-text": core.dxp.i18n.t('Calendar:accessibilityDateInputText'), placeholder: "mm/dd/yyyy", readonly: true })), core.h("div", { class: this.selectorCalendarIcon, "aria-expanded": this.isCalendarOpen, "aria-label": core.dxp.i18n.t('Calendar:accessibilityIconText'), role: "button", tabindex: "-1" })), this.isCalendarOpen &&
            core.h("div", { class: "sc-dxp-calendar overlay", role: "application", tabindex: "-1" }, core.h("div", { class: "sc-dxp-calendar calendar-modal", tabindex: "-1" }, core.h("div", { class: "sc-dxp-calendar calendar-header", tabindex: "-1" }, core.h("div", { class: "sc-dxp-calendar action-container arrow-holder left", role: "none" }, core.h("span", { tabindex: "0", "aria-label": core.dxp.i18n.t('Calendar:accessibilityPrevIconText'), class: "sc-dxp-calendar prev-icon" })), core.h("div", { tabindex: "-1", class: "sc-dxp-calendar dxp-dropdown-container calendar-month-dropdown dxp-dropdown-md" }, core.h("div", { class: "sc-dxp-calendar action-container dxp-list-container-dropdown", id: "month-list-container-dropdown" }, core.h("dxp-select", { selector: `${this.selectorMonth}`, useIndexAsValue: true, dataList: this.months }))), core.h("div", { class: "sc-dxp-calendar dxp-dropdown-container calendar-year-dropdown dxp-dropdown-md", tabindex: "-1" }, core.h("div", { class: "sc-dxp-calendar action-container dxp-list-container-dropdown", id: "year-list-container-dropdown", tabindex: "-1" }, core.h("dxp-select", { selector: `${this.selectorYear}`, dataList: this.yearDropdownDataList }))), core.h("div", { class: "sc-dxp-calendar action-container arrow-holder right", role: "none" }, core.h("span", { tabindex: "0", "aria-label": core.dxp.i18n.t('Calendar:accessibilityNextIconText'), class: "sc-dxp-calendar next-icon" }))), core.h("div", { class: "sc-dxp-calendar dxp-row dxp-no-outline", tabindex: "-1" }, core.h("div", { class: `sc-dxp-calendar ${this.selectorCalendarView}` }, this.calDivList.map(_test => {
                return core.h("div", { class: "sc-dxp-calendar date-div dxp-no-outline", tabindex: "-1" });
            }))), this.message ?
                core.h("div", { class: "dxp-no-outline", tabindex: "-1" }, core.h("div", { class: "calendar-note dxp-col-12" }, core.h("p", null, core.h("span", { class: "info-icon", "aria-label": core.dxp.i18n.t('Calendar:informationIconLabel') }), core.h("span", { innerHTML: `${this.message}` })))) : ''))));
    }
