...
const ImageGrid = class {
    ...
    render() {
        core$1.dxp.log.debug(this.element.tagName, 'render()', `in dxp-image-grid render() : ${"DEVELOPMENT"}`);
        const styles = [
            core$1.h("link", { rel: "stylesheet", href: `` }),
            [this.theme && core$1.h("link", { rel: "stylesheet", href: `` })]
        ];
        return (core$1.h("div", { class: `${this.base.componentClass()} sc-dxp-image-grid`, dir: this.dir, "data-theme": this.theme }, styles, core$1.h("div", { id: "dxp-image-grid-container", class: "dxp-image-grid-container" }, core$1.h("div", { class: `${this.layoutOption} sc-dxp-image-grid image-grid-container`, ref: el => this.imagesContainer = el }, core$1.h("slot", null)))));
    }
...
exports.dxp_image_grid = ImageGrid;
