...
const RegionSelector = class {
    constructor(hostRef) {
        ...
        this.buttonClick = core$1.createEvent(this, "buttonClick", 7);
    }
    /** actions to be performed prior to component loading */
    async componentWillLoad() {
        this.base = new baseComponent_esm.BaseComponent(this, core$1.dxp);
        this.base.i18Init(core$1.dxp, 'RegionSelector', messages);
        ...
        if (this.countryLanguagePageLink) {
            this.siteList.push({ text: this.countryLanguagePageText || core$1.dxp.i18n.t('RegionSelector:countryLanguagePageText'), link: this.countryLanguagePageLink });
        }
    }
    ...
    async getSiteList() {
        if (this.apiUrl) {
            try {
                return this.parseSiteList(await core$1.dxp.api(this.apiUrl));
            }
            catch (err) {
                core$1.dxp.log.error(this.element.tagName, 'getSiteList()', `fetch failed for ${this.apiUrl}`, err);
            }
        }
    }
    ...
    render() {
        if (!this.compareLocales() && this.siteList) {
            const styles = [
                core$1.h("link", { rel: "stylesheet", href: `${core$1.dxp.config.get('DXP_STYLE_BASE_URL')}/dxp.css` }),
                [this.theme && core$1.h("link", { rel: "stylesheet", href: `` })],
                [this.theme && core$1.h("link", { rel: "stylesheet", href: `${core$1.dxp.config.get('DXP_STYLE_BASE_URL')}/themes/${this.theme}/dxp-region-selector.min.css` })]
            ];
            return (core$1.h("div", { class: this.base.componentClass(), dir: this.dir, "data-theme": this.theme }, styles, core$1.h("div", { class: "padding" }, core$1.h("div", { class: "dxp-row" }, core$1.h("div", { class: "dxp-col-12" }, core$1.h("div", { class: "region-selector-wrapper" }, core$1.h("div", { class: "dxp-col-sm-12 dxp-col-md-12 dxp-col-lg-6" }, this.eyebrowText && core$1.h("p", { class: "eyebrow-text", innerHTML: this.eyebrowText }), this.titleText && core$1.h("p", { class: "title-text", innerHTML: this.titleText })), core$1.h("div", { class: "dxp-col-sm-12 dxp-col-md-12 dxp-col-lg-6" }, core$1.h("div", { class: "close-icon", onClick: () => this.dismissRegionSelector(), onKeyUp: e => e.keyCode === 13 && this.dismissRegionSelector() }, core$1.h("span", { class: `dxp-icon dxp-icon-close`, "aria-label": core$1.dxp.i18n.t('RegionSelector:close'), tabIndex: 3 })), core$1.h("div", { class: "row-reverse dxp-col-sm-12" }, this.buttonText && core$1.h("div", { class: "cta-button", tabIndex: -1 }, core$1.h("dxp-cta", { type: "button", "button-type": "secondary", text: this.buttonText, tabIndex: 2 })), core$1.h("div", { class: "select-button" }, core$1.h("select", { tabIndex: 1 }, this.siteList.map(site => {
                if (site.hasOwnProperty('country')) {
                    return core$1.h("option", null, `${site['country']} - ${site['language']}`);
                }
                return core$1.h("option", null, site['text']);
            })))))))))));
        }
    }
...
exports.dxp_region_selector = RegionSelector;
