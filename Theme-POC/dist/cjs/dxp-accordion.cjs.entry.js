...
const Accordion = class {
    ...
    componentWillLoad() {
        ...
        this.base.i18Init(core.dxp, 'Accordion', messages.messages);
    ...
    render() {
        core.dxp.log.debug(this.element.tagName, 'render()', `in dxp-accordion render() : ${"DEVELOPMENT"}`);
        const styles = [
            core.h("link", { rel: "stylesheet", href: `` }),
            [core.h("link", { rel: "stylesheet", href: `${core.dxp.config.get('DXP_STYLE_BASE_URL')}/themes/${this.theme}/dxp-accordion.min.css` })],
            [this.theme && core.h("link", { rel: "stylesheet", href: `` })]
        ];
        return (core.h("div", { class: this.base.componentClass(), dir: this.dir, "data-theme": this.theme }, styles, core.h("div", { class: "toggle" }, core.h("div", { class: "dxp-row" }, this.isHeaderRequired &&
            core.h("div", { class: "dxp-col-12" }, core.h("p", { class: "title-wrapper" }, core.h("span", { class: "dxp-text-eyebrow dxp-col-sm-6 dxp-col-12" }, this.heading), ((this.childElementCount > 1) || (this.items && this.items.length > 1)) ?
                core.h("span", { class: "dxp-col-sm-6 dxp-col-12" }, core.h("span", { tabindex: "0", class: "expand-all dxp-no-outline", role: "button" }, core.dxp.i18n.t('Accordion:expandAll')), core.h("span", { class: "pipe-separator" }), core.h("span", { tabindex: "0", class: "collapse-all dxp-no-outline", role: "button" }, core.dxp.i18n.t('Accordion:collapseAll'))) : ''))), this.items ? this.items.map((item) => {
            return (core.h("dxp-accordion-item", { "item-title": item.title, "item-subtitle": item.subtitle, "item-description": item.description, "show-expanded": item.showExpanded }));
        }) :
            core.h("div", { ref: el => this.accItemContainer = el }, core.h("slot", null)))));
    }
...
exports.dxp_accordion = Accordion;
