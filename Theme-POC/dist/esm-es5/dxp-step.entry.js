...
var Step = /** @class */ (function () {
     ...
     */
    Step.prototype.routingHandler = function (event) {
        this.base.routingEventListener(event);
    };
    /** emits selected steps data */
    Step.prototype.emitData = function (name, status, stepData) {
        var stepSelected = {
            stepName: name,
            stepStatus: status,
            stepInfo: stepData
