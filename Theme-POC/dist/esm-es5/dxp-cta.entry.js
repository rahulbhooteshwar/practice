...
var JAVASCRIPT_VOID = 'javascript:void(0)';
var Cta = /** @class */ (function () {
    function Cta(hostRef) {
    ...
    Cta.prototype.componentWillLoad = function () {
        this.base = new BaseComponent(this, dxp);
    };
    /** actions to be performed after  component loading */
    Cta.prototype.componentDidLoad = function () {
        var ctaContainer = this.element ? this.element.querySelector('.dxp-cta') : this.element.querySelector('.dxp-cta');
        var ctaBtn = this.element ? this.element.querySelector('.dxp-btn') : this.element.querySelector('.dxp-btn');
        var btnBlockClass = 'dxp-btn-block';
    ...
    Cta.prototype.calculateButtonSize = function (buttonSize) {
        return buttonSize ? "btn-" + buttonSize : '';
    };
    /** emit analytic data */
    Cta.prototype.emitAnalyticsData = function () {
    ...
    /** redirecting to link */
    Cta.prototype.redirectToLink = function (e) {
        if (this.disabled) {
            e.preventDefault();
            e.stopPropagation();
        }
    ...
    Cta.prototype.renderButton = function () {
        var _this = this;
        var buttonSizeIs = this.calculateButtonSize(this.buttonSize);
        return (h("div", { class: (this.disabled ? ' disable-cover ' : '') + " dxp-cta-with-icon" }, h("button", { class: "dxp-btn dxp-btn-" + this.buttonType + " " + buttonSizeIs + " " + (this.disabled ? ' disabled pointer-event-off' : ''), title: this.text, tabindex: this.disabled ? -1 : '', "aria-label": this.text, onClick: function (ev) { return _this.redirectToLink(ev); }, "aria-disabled": this.disabled && 'true' }, this.text && this.src && this.iconAlign.toLowerCase() === 'left' && this.buttonType !== 'branded' &&
    ...
    Cta.prototype.renderLinkIcon = function (isAnchorWithButtonUI, position) {
     ...
     */
    Cta.prototype.routingHandler = function (event) {
        this.base.routingEventListener(event);
        this.ctaClickEvent.emit({ event: event, href: this.href, text: this.text, disabled: this.disabled });
    ...
    Cta.prototype.showBadge = function () {
