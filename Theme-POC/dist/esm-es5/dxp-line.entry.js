...
var Line = /** @class */ (function () {
    ...
    Line.prototype.componentWillLoad = function () {
     ...
     */
    Line.prototype.routingHandler = function (event) {
        this.base.routingEventListener(event);
    };
    /** returnCalHeight */
    Line.prototype.getCalHeight = function () {
    ...
    Line.prototype.getClassName = function (type) {
        var className = {
            'double': 'double',
            'box': 'box',
