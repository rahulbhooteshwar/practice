...
var GridPagination = /** @class */ (function () {
    function GridPagination(hostRef) {
    ...
    GridPagination.prototype.totalRowsChangeHandler = function (newValue, oldValue) {
        if (newValue !== oldValue) {
            var pageIfRemainder = (this.totalRows % this.totalRowsPerPage) > 0 ? 1 : 0;
    ...
    GridPagination.prototype.componentWillLoad = function () {
    ...
    GridPagination.prototype.componentDidLoad = function () {
        var pageIfRemainder = (this.totalRows % this.totalRowsPerPage) > 0 ? 1 : 0;
        this.totalPages = Math.floor(this.totalRows / this.totalRowsPerPage) + pageIfRemainder;
    };
    /** Listener to value from dxp-input component */
    GridPagination.prototype.inputEntered = function (event) {
        this.gotoPage(event);
    };
    /** method for showing indexing of current page */
    GridPagination.prototype.getTextForCurrentPage = function () {
    ...
    GridPagination.prototype.gotoPage = function (e) {
        e.preventDefault();
        this.isValidPageNumber = true;
        ...
        if (selectedTarget.classList.contains('icon-next')) {
            ...
            var manualEnteredText = Number(e.detail.value);
    ...
    GridPagination.prototype.updateDataGridIndex = function () {
    ...
    GridPagination.prototype.render = function () {
        var _this = this;
        ...
        return (h("div", { class: this.base.componentClass() + " grid-pagination", "data-theme": this.theme, style: { 'width': this.width || 'auto' } }, this.showPaginationSection &&
            (h("div", { class: "paging-panel" }, h("span", { class: "paging-page-summary-panel" }, h("a", { href: "javascript : void(0)", role: "button", onClick: function (e) { return _this.gotoPage(e); }, title: dxp.i18n.t('GridPagination:firstText'), class: "item-icon icon-first" }), h("a", { href: "javascript : void(0)", role: "button", onClick: function (e) { return _this.gotoPage(e); }, title: dxp.i18n.t('GridPagination:previousText'), class: "item-icon icon-previous" }), dxp.i18n.t('GridPagination:pageTxt'), " ", h("span", { class: "paging-text input" }, h("dxp-input", { type: "number", "content-id": "manual-enter-input", "is-required": "false", min: "1", max: this.totalPages ? this.totalPages.toString() : '', label: "", "enable-autocomplete": "off", readonly: false, value: this.currentPageIndex, disabled: false })), " ", dxp.i18n.t('GridPagination:ofTxt'), " ", h("span", null, this.totalPages), h("a", { href: "javascript : void(0)", role: "button", onClick: function (e) { return _this.gotoPage(e); }, title: dxp.i18n.t('GridPagination:nextText'), class: "item-icon icon-next" }), h("a", { href: "javascript : void(0)", role: "button", onClick: function (e) { return _this.gotoPage(e); }, title: dxp.i18n.t('GridPagination:lastText'), class: "item-icon icon-last" })), this.isValidPageNumber ?
    ...
    Object.defineProperty(GridPagination.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(GridPagination, "watchers", {
        get: function () {
            return {
