...
var Timer = /** @class */ (function () {
    ...
    Timer.prototype.componentDidLoad = function () {
        if (this.timerType !== 'stopwatch') {
     ...
     */
    Timer.prototype.routingHandler = function (event) {
        this.base.routingEventListener(event);
    };
    /** to reset the stopwatch */
    Timer.prototype.onReset = function () {
    ...
    Timer.prototype.onStart = function (e) {
        var currentTarget = e.currentTarget.getAttribute('btn-title');
    ...
    /** reset timer */
    Timer.prototype.resetTimeCounter = function () {
        var counterUpdater = {};
        for (var _i = 0, _a = this.selectedUnitRange; _i < _a.length; _i++) {
            var unit = _a[_i];
    ...
    Timer.prototype.setTimeCounter = function () {
        this.timerStart = dxp.moment.utc().clone();
        var timeCheck = (this.timerType === 'countdown') ? dxp.moment.utc(this.timerEnd).isSameOrAfter(this.timerStart)
    ...
    Timer.prototype.render = function () {
        ...
        return (h("div", { class: "" + this.base.componentClass(), dir: this.dir, "data-theme": this.theme }, styles, h("div", { class: this.displayDirection + " " + this.timerSize }, (this.showError) ?
            ...
            Object.keys(this.timeCounter).map(function (unit) { return (h("div", { class: "unit-wrapper" }, h("div", { class: "unit-count" }, _this.timeCounter[unit]), h("div", { class: "unit-label" }, dxp.i18n.t("Timer:" + unit)))); })), this.timerType === 'stopwatch' && !this.showError ?
            h("div", { class: "" + this.displayDirection }, h("dxp-cta", { type: "button", "btn-title": this.buttonTitle, "button-type": "secondary", text: this.buttonText, onClick: function (e) { return _this.onStart(e); } }), h("dxp-cta", { type: "button", "btn-title": "reset-button", "button-type": "secondary", text: dxp.i18n.t('Timer:reset'), onClick: function () { return _this.onReset(); } })) : ''));
    };
    Object.defineProperty(Timer.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Timer, "style", {
        get: function () { return "div.dxp.dxp-timer{-ms-flex-direction:column;flex-direction:column}div.dxp.dxp-timer,div.dxp.dxp-timer .horizontal,div.dxp.dxp-timer .vertical{display:-ms-inline-flexbox;display:inline-flex;-ms-flex-wrap:wrap;flex-wrap:wrap}div.dxp.dxp-timer .horizontal,div.dxp.dxp-timer .vertical{padding:.16rem}div.dxp.dxp-timer .horizontal dxp-cta:not(:first-child){padding-left:.5rem}div.dxp.dxp-timer .vertical{-ms-flex-direction:column;flex-direction:column}div.dxp.dxp-timer .vertical dxp-cta:not(:first-child){padding-top:.5rem}div.dxp.dxp-timer .unit-wrapper{-ms-flex:1 1 auto;flex:1 1 auto;text-align:center;min-width:4rem;margin:.16rem;padding:.25rem .5rem}div.dxp.dxp-timer .unit-wrapper.error-msg{width:20rem}div.dxp.dxp-timer .large{padding:.25rem}div.dxp.dxp-timer .large .unit-wrapper{margin:.25rem;min-width:6rem;padding:.75rem 1.5rem}\@media (max-width:767px){div.dxp.dxp-timer{padding:.1rem}div.dxp.dxp-timer .unit-wrapper{min-width:3rem;margin:.1rem;padding:.1rem .3rem}div.dxp.dxp-timer .large{padding:.25rem}div.dxp.dxp-timer .large .unit-wrapper{margin:.25rem;min-width:4rem;padding:.5rem 1.2rem}}"; },
        enumerable: true,
        configurable: true
    });
    return Timer;
