...
var ToggleSwitch = /** @class */ (function () {
    function ToggleSwitch(hostRef) {
    ...
    ToggleSwitch.prototype.componentWillLoad = function () {
    ...
    ToggleSwitch.prototype.onClick = function (event) {
        this.clickHandler.emit(event);
        this.base.routingEventListener(event);
    };
    /** emit analytic data */
    ToggleSwitch.prototype.emitAnalyticsData = function () {
        var el;
    ...
    /** emit toggle data */
    ToggleSwitch.prototype.emitData = function () {
        var el;
        el = this.element.querySelector('[type=checkbox]');
        var dataObj = {
            'value': el && el.value,
