...
var Progressspinner = /** @class */ (function () {
    function Progressspinner(hostRef) {
    ...
    Progressspinner.prototype.componentWillLoad = function () {
        if (this.radius < 15) {
            this.radius = 15;
        }
        if (this.radius > 20) {
     ...
     */
    Progressspinner.prototype.routingHandler = function (event) {
